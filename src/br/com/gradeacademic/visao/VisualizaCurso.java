...
import br.com.gradeacademic.servico.AcaoVisualizaCurso;

public class VisualizaCurso extends Principal {
	...
	public static void visualizarCurso() {
		...
		internalVisualiza = new JInternalFrame("Cursos");
	...
	private static void tabela(JInternalFrame internalVizualiza) {
		...
		tabela.setModel(new DefaultTableModel(new Object[] { "ID", "Nome", "Coordenador", "Duração (em Anos)" }, 0) {
			@Override
		...
		AcaoVisualizaCurso.listarCurso((DefaultTableModel) tabela.getModel());
	}
