...
import br.com.gradeacademic.servico.AcaoVisualizaPais;

public class VisualizaPais extends Principal {
	...
	public static void visualizarPais() {

		internalVisualiza = new JInternalFrame("Paises");
	...
	private static void tabela(JInternalFrame internalVizualiza) {
		...
		tabela.setModel(new DefaultTableModel(new Object[] { "ID","Pais", "nome" }, 0) {
			@Override
	...
	scroll = new JScrollPane();
		...
		AcaoVisualizaPais.listarPais((DefaultTableModel) tabela.getModel());
	}
